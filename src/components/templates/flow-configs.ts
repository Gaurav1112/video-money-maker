...
export const NetworkFlowConfig: FlowConfig = {
  ...
  stages: [
    ...
    },
    {
      ...
      color: '#FBBF24',
      beatIndex: 2,
      description: 'Certificate exchange',
    },
    {
      id: 'http',
      label: 'HTTP Request',
...
export const ConcurrencyControlVizConfig: FlowConfig = {
  ...
  stages: [
    ...
    },
    {
      ...
      color: '#F59E0B',
      beatIndex: 1,
      description: 'Optimistic / Pessimistic',
    },
    {
      id: 'validate',
      label: 'Validate',
...
export const BlueGreenCanaryVizConfig: FlowConfig = {
  ...
  stages: [
    ...
    },
    {
      ...
      color: '#632CA6',
      beatIndex: 3,
      description: 'Error rate / latency',
    },
    {
      id: 'promote',
      label: 'Promote',
...
export const FeatureFlagVizConfig: FlowConfig = {
  ...
  stages: [
    ...
    },
    {
      ...
      color: '#F59E0B',
      beatIndex: 1,
      description: 'User context check',
    },
    {
      id: 'variant',
      label: 'Variant',
...
export const GRPCVizConfig: FlowConfig = {
  ...
  stages: [
    ...
    },
    {
      ...
      color: '#60A5FA',
      beatIndex: 2,
      description: 'Serialize (Protobuf)',
    },
    {
      id: 'http2',
      label: 'HTTP/2',
      ...
      color: '#20C997',
      beatIndex: 3,
      description: 'Multiplexed stream',
    },
    {
      id: 'server',
      ...
      color: '#EF4444',
      beatIndex: 4,
      description: 'Deserialize & respond',
    },
  ],
};
