...
export const ScaleComparison: ComparisonConfig = {
  ...
  rows: [
    {
      attribute: 'Approach',
      optionA: 'Add more machines',
      optionB: 'Upgrade existing machine',
      winner: 'tie',
      beatIndex: 0,
    },
    {
      attribute: 'Cost Curve',
      optionA: 'Linear (commodity HW)',
      optionB: 'Exponential (high-end HW)',
      winner: 'A',
      beatIndex: 1,
    },
    {
      attribute: 'Fault Tolerance',
      optionA: 'Built-in redundancy',
      optionB: 'Single point of failure',
      winner: 'A',
      beatIndex: 2,
    },
    {
      attribute: 'Complexity',
      optionA: 'Distributed state mgmt',
      optionB: 'Simple — single process',
      winner: 'B',
      beatIndex: 3,
    },
    {
      attribute: 'Data Consistency',
      optionA: 'Eventual / partitioned',
      optionB: 'Strong (single node)',
      winner: 'B',
      beatIndex: 4,
    },
    {
      attribute: 'Max Capacity',
      optionA: 'Virtually unlimited',
      optionB: 'Hardware ceiling',
      winner: 'A',
      beatIndex: 5,
    },
  ],
...
export const APIVersioningViz: ComparisonConfig = {
  ...
  rows: [
    {
      attribute: 'Example',
      optionA: '/api/v2/users',
      optionB: 'Accept: application/vnd.api.v2+json',
      winner: 'tie',
      beatIndex: 0,
    },
    {
      attribute: 'Discoverability',
      optionA: 'Visible in URL',
      optionB: 'Hidden in headers',
      winner: 'A',
      beatIndex: 1,
    },
    {
      attribute: 'Cache Friendly',
      optionA: 'Each version = new URL',
      optionB: 'Same URL, vary header',
      winner: 'A',
      beatIndex: 2,
    },
    {
      attribute: 'Clean URLs',
      optionA: 'Version pollutes path',
      optionB: 'Resource-centric URLs',
      winner: 'B',
      beatIndex: 3,
    },
    {
      attribute: 'Client Effort',
      optionA: 'Change URL string',
      optionB: 'Set header per request',
      winner: 'A',
      beatIndex: 4,
    },
    {
      attribute: 'Industry Usage',
      optionA: 'GitHub, Stripe, Twilio',
      optionB: 'Microsoft, GitHub (also)',
      winner: 'tie',
      beatIndex: 5,
    },
  ],
  ...
  rows: [
    {
      ...
      optionA: 'Human-readable text',
      optionB: 'Binary — needs tooling',
      winner: 'A',
      beatIndex: 0,
    },
    {
      attribute: 'Payload Size',
      optionA: '~1 KB for 10 fields',
      optionB: '~200 B for 10 fields',
      winner: 'B',
      beatIndex: 1,
    },
    {
      attribute: 'Parse Speed',
      optionA: '~50 \u00B5s',
      optionB: '~5 \u00B5s',
      winner: 'B',
      beatIndex: 2,
    },
    {
      ...
      optionA: 'No enforced schema',
      optionB: 'Backward/forward compat',
      winner: 'B',
      beatIndex: 3,
    },
    {
      attribute: 'Browser Support',
      optionA: 'Native JSON.parse()',
      optionB: 'Requires JS library',
      winner: 'A',
      beatIndex: 4,
    },
    {
      attribute: 'Debugging',
      optionA: 'Paste in any editor',
      optionB: 'Need protoc / avro-tools',
      winner: 'A',
      beatIndex: 5,
    },
    {
      attribute: 'Best For',
      optionA: 'REST APIs, config files',
      optionB: 'gRPC, Kafka, big data',
      winner: 'tie',
      beatIndex: 6,
    },
  ],
