...
export const MICROSERVICES_OVERVIEW: ArchitectureConfig = {
  ...
  flows: [{ path: ['client', 'gateway', 'user', 'db2'], color: C.server, beatIndex: 4 }],
};
...
export const MESSAGE_QUEUE_OVERVIEW: ArchitectureConfig = {
  ...
  flows: [{ path: ['producer', 'queue', 'consumer1', 'db'], color: C.queue, beatIndex: 4 }],
};
...
export const API_GATEWAY_OVERVIEW: ArchitectureConfig = {
  ...
  flows: [{ path: ['web', 'gateway', 'svc1', 'db'], color: C.server, beatIndex: 5 }],
};
...
export const DISTRIBUTED_OVERVIEW: ArchitectureConfig = {
  ...
  flows: [{ path: ['client', 'lb', 'node1', 'consensus'], color: C.cache, beatIndex: 4 }],
};
...
export const SEARCH_ENGINE_OVERVIEW: ArchitectureConfig = {
  ...
  flows: [{ path: ['client', 'api', 'index', 'ranker', 'store'], color: C.cache, beatIndex: 4 }],
};
