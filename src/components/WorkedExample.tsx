...
export function deriveWorkedExample(explanation: string, options: string[], correctIndex: number): WorkedExampleData | null {
  // Find first company / product name (capitalized).
  const companyRe = /\b(LinkedIn|Netflix|Uber|Google|Amazon|Stripe|GitHub|Shopify|Discord|Instagram|WhatsApp|Twitter|Facebook|YouTube|GitLab|Spotify|Reddit|TikTok|Microsoft|Apple)\b/;
...
export const WorkedExample: React.FC<Props> = ({
  data, twistFallback, startFrame, durationFrames,
}) => {
  ...
  const beforeS = spring({
    frame: Math.max(0, beforeAge), fps,
    config: { stiffness: 170, damping: 16, mass: 0.6 },
  });
  const afterS = spring({
    frame: Math.max(0, afterAge), fps,
    config: { stiffness: 170, damping: 16, mass: 0.6 },
  });
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          fontSize: 22, fontFamily: FONTS.text, fontWeight: 700,
          color: '#22D3EE', textTransform: 'uppercase', letterSpacing: 4,
          marginBottom: 10,
        }}>
          REAL WORLD
        </div>
        <div style={{
          ...
          color: TEXT, lineHeight: 1.1, letterSpacing: -1,
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            color: RED, textTransform: 'uppercase', letterSpacing: 2,
            marginBottom: 16,
          ...
          <div style={{
            fontSize: 32, fontFamily: FONTS.text, fontWeight: 600,
        ...
        <div style={{
          alignSelf: 'center',
          fontSize: 80, fontFamily: FONTS.heading, fontWeight: 900,
          color: '#FBBF24',
        ...
        <div style={{
          ...
          <div style={{
            fontSize: 36, fontFamily: FONTS.heading, fontWeight: 900,
            color: GREEN, textTransform: 'uppercase', letterSpacing: 2,
            marginBottom: 16,
      ...
      <div style={{
        textAlign: 'center',
        fontSize: 22, fontFamily: FONTS.text, fontWeight: 600,
