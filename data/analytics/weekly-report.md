...
## Per-formula comparison (last N=29 paired uploads)

| Formula | n_videos | median completion % | median views |
|---------|----------|---------------------|--------------|
| specific_stat | 29 | 0.0% | 0 |
| wrong_answer_first | 29 | 0.0% | 0 |
