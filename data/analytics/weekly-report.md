...
## Per-formula comparison (last N=13 paired uploads)

| Formula | n_videos | median completion % | median views |
|---------|----------|---------------------|--------------|
| specific_stat | 13 | 0.0% | 0 |
| wrong_answer_first | 13 | 0.0% | 0 |
