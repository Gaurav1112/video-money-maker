...
## Per-formula comparison (last N=22 paired uploads)

| Formula | n_videos | median completion % | median views |
|---------|----------|---------------------|--------------|
| specific_stat | 22 | 0.0% | 0 |
| wrong_answer_first | 22 | 0.0% | 2 |
