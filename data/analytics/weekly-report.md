...
| `Z4iCdKDkXzA` | 1 | 4.5% | 1.0 | 0 | 0 |
| `JlXKC5g-cm0` | 1 | 3.9% | 0.0 | 0 | 0 |
...
## Per-formula comparison (last N=34 paired uploads)

| Formula | n_videos | median completion % | median views |
|---------|----------|---------------------|--------------|
| specific_stat | 34 | 0.0% | 0 |
| wrong_answer_first | 34 | 0.0% | 0 |
