...
## Per-formula comparison (last N=18 paired uploads)

| Formula | n_videos | median completion % | median views |
|---------|----------|---------------------|--------------|
| specific_stat | 18 | 0.0% | 0 |
| wrong_answer_first | 18 | 0.0% | 0 |
